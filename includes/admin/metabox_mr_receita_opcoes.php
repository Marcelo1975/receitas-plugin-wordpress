<?php
function mr_receita_opcoes($post) {
	...
	Ingredientes:<br/>
	<input type="text" name="mr_ingredientes" value="<?php echo $receita_data['ingredientes']; ?>" /><br/><br/>

	Tempo da receita:<br/>
	<input type="text" name="mr_tempo" value="<?php echo $receita_data['tempo']; ?>" /><br/><br/>

	Utensílios:<br/>
	<input type="text" name="mr_utensilios" value="<?php echo $receita_data['utensilios']; ?>" /><br/><br/>

	Nível de dificuldade:<br/>
	<select name="mr_dificuldade">
	...
	Tipo de receita:<br/>
	<input type="text" name="mr_tipo" value="<?php echo $receita_data['tipo']; ?>" />
